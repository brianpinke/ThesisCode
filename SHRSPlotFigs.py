...
multi_shrs_plots(
    plot_details=[
        {'data': [MMLR,'LDV', 'PL', 'HDV', 'OW', 'HGM'],
         'colors': [meagercolor, lightpurple, pink, darkpurple, orange, green],
        ...
        {'data': [MRWR,'PN', 'TV', 'VV', 'WW'],
         'colors': [tahomacolor, darkpurple, lightpurple, lightpurple, orange],
         'title': 'Tahoma liths',
         'deposit': MRWR},
        
        {'data': [MRKC,'NV', 'V', 'PL'],
         'colors': [kautzcolor, darkpurple, lightpurple, pink],
         'title': 'Kautz liths',
         'deposit': MRKC},
        
        {'data': [MASC,'NA', 'NN', 'VN', 'VA'],
         'colors': [adamscolor,orange, darkpurple, lightpurple, lighterorange],
